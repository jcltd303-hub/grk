  ...
  return (
    <div className="relative w-full h-full bg-slate-950 overflow-hidden select-none">
      ...
      <div className="absolute bottom-3 left-1/2 -translate-x-1/2 flex items-center gap-1.5 sm:gap-2 bg-slate-900/95 backdrop-blur-md p-1.5 sm:p-2 rounded-2xl border border-slate-800/90 shadow-2xl z-20 max-w-[96vw] overflow-x-auto custom-scrollbar">
        ...
        {/* 1-CLICK AUTO-RIG & AUTO-WIDTHS */}
        <div className="flex items-center gap-1 bg-slate-950/70 p-1 rounded-xl border border-slate-800/70">
          <button
            id="btn_viewport_auto_rig"
            onClick={() => studioStore.autoRig()}
            title="Automatically detect character silhouette, place bones, fit bone widths and bind weights"
            className="px-2.5 py-1.5 bg-gradient-to-r from-sky-500/20 to-indigo-500/20 hover:from-sky-500/30 hover:to-indigo-500/30 text-sky-200 border border-sky-500/30 rounded-lg text-xs font-semibold flex items-center gap-1 transition shrink-0"
          >
            <Wand2 className="w-3.5 h-3.5 text-amber-300" />
            <span>Auto-Rig</span>
          </button>
          <button
            id="btn_viewport_auto_widths"
            onClick={() => studioStore.autoBoneWidths()}
            title="Automatically calculate and set bone widths to fit character geometry"
